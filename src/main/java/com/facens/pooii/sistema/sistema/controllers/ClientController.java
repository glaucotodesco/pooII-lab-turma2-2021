...
public class ClientController {
    ...
    public ResponseEntity<Page<ClientDTO>> getClients(
        ...
        Page<ClientDTO> list = service.getClients(pageRequest, name, address);
    ...
    @PutMapping("{id}")
	public ResponseEntity<ClientDTO> update(@PathVariable Long id, @RequestBody ClientUpdateDTO updateDto){
